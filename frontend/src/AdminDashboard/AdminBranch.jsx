...
const AdminBranch = () => {
  ...
  useEffect(() => {
    axios
      .get("https://coffeehouse-4yii.onrender.comapi/admin/branches")
      .then((res) => {
  ...
  const handleTitleDescriptionSubmit = (e) => {
    e.preventDefault();
    axios
      .put("https://coffeehouse-4yii.onrender.comapi/admin/branches/title-description", { title, description })
  ...
  const handleBranchAdd = (e) => {
    ...
    axios
      .post("https://coffeehouse-4yii.onrender.comapi/admin/branches/add", formData)
      .then((res) => {
  ...
  const handleBranchDelete = (branchId) => {
    axios
      .delete(`https://coffeehouse-4yii.onrender.comapi/admin/branches/delete/${branchId}`)
      .then((res) => {
        setBranches(res.data.branch.branches);
        setFeedbackMessage(res.data.message);
      })
  ...
  const handleBranchEditSubmit = (e, branchId) => {
    ...
    axios
      .put(`https://coffeehouse-4yii.onrender.comapi/admin/branches/edit/${branchId}`, formData)
      .then((res) => {
        setBranches(res.data.branch.branches);
  ...
  const handleToggleFeatured = (branchId) => {
    axios
      .put(`https://coffeehouse-4yii.onrender.comapi/admin/branches/toggle-featured/${branchId}`)
      .then((res) => {
        setBranches(res.data.branch.branches);
        setFeedbackMessage(res.data.message);
      })
