...
const AdminMenu = () => {
  ...
  const handleAddMenuItem = (e) => {
    ...
    axios.post("http://localhost:5000/api/menu/add", formData)
      .then((res) => {
        setMenuItems(res.data.menuItems);
  ...
  const handleEditMenuItem = (e, id) => {
    ...
    axios.put(`http://localhost:5000/api/menu/edit/${id}`, formData)
      .then((res) => {
        setMenuItems(res.data.menuItems);
        setEditingItem(null);
        setEditImagePreview(null);
  ...
  const handleToggleFeatured = (id) => {
    setLoading(true);
    axios.put(`http://localhost:5000/api/menu/toggle-featured/${id}`)
      .then((res) => {
        setMenuItems(res.data.menuItems);
        alert(res.data.message);
        setLoading(false);
